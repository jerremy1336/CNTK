...
If you are coming from another toolkit you can start with an `overview for advanced users <https://github.com/Microsoft/CNTK/blob/master/Tutorials/CNTK_200_GuidedTour.ipynb>`__
